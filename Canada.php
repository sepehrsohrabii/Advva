...
<html lang="en-US">
    <head>
        ...
        <meta name="apple-mobile-web-app-title" content="Advva - Canada">
        <meta name="robots" content="max-image-preview:large">
        <meta itemprop="name" content="Advva - Canada">
        <meta itemprop="url" content="">

        <title>Advva - Canada</title>
    ...
    <body>
        ...
        <main class="position-relative overflow-hidden">
            ...
            <div class="sliderCanada">

            </div>
            <div class="bg1 d-flex align-items-center py-5">
                <div class="container py-5">
                    <div class="row my-5 text-md-start text-center">
                        <div class="col-12 col-md-4 border-end border-secondary pe-md-5 py-md-4">
                            <img src="/img/location-icon.svg" alt="Advva Address">
                            <h5 class="fs-5 color2 mt-3"><a class="color2" href="https://goo.gl/maps/EGKKQtYw2yfwxX5x7">120 Sheppard Ave.
                                North York, ON M2N 1M5</a></h5>
                        </div>
                        <div class="col-12 col-md-4 my-md-0 my-5 border-end border-secondary px-md-5 py-md-4">
                            ...
                            <h5 class="fs-5 color2 mt-3">
                                <a class="color2" href="tel:416-993-2322">Tel:416-993-2322</a></br>
                                <a class="color2" href="tel:647-828-8900">Cell:647-828-8900</a></h5>
                        </div>
